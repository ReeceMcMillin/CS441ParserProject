...
;;; (parse-string identifier/p "abc")
;;; (parse-string identifier/p "a12")
;;; (parse-string identifier/p "1a2")
;;; (parse-string identifier/p "a-12")
;;; (parse-string identifier/p "a1?2")
;;; (parse-string identifier/p "__private")
;;; (parse-string identifier/p "_____superprivate")
;;; (parse-string identifier/p "__________1nvalid")
